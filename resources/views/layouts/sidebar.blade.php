<div id="sidebar" class="block absolute z-90 bg-white w-full border-b -mb-16 lg:-mb-0 lg:static lg:bg-transparent lg:border-b-0 lg:pt-0 lg:w-1/4 lg:border-0 xl:w-1/6 sm:flex md:flex md:relative sm:relative">
