<template>
    <layout>
        ...
        <div class="grid" v-for="billableStatus in ['billable', 'not_billable']" :key="billableStatus">
            <table class="bg-white rounded shadow">
                <thead>
                    <tr v-if="billableStatus === 'billable'">
                        <th class="text-center w-full bg-indigo-200 mb-2" colspan="4">
                            <h3 class="text-indigo-900 uppercase text-xl font-light"> This Week </h3>
                        </th>
                    </tr>
                    <tr class="bg-indigo-100">
                        <td class="pl-1 sm:pr-2" colspan="4">
                            <div class="uppercase text-indigo-700 text-sm"> All Clients {{ billableStatus }} </div>
                        </td>
                    </tr>
                    <tr>
