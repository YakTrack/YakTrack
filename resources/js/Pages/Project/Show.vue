<template>
    <layout>
        ...
        <div class="card">
            ...
            <project-tab-nav :project-id="project.id" :active-tab="tab" />
        </div>
        ...
        <template v-if="tab === 'overview'">
            ...
            <div v-if="sessions && sessionsTable" class="mt-4">
                <h2 class="text-lg font-medium text-gray-dark dark:text-gray-100 mb-3 px-1">Sessions</h2>
